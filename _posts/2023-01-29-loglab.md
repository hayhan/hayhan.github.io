...
*Loglab* is an analyzer of system/app logs. Unlike most of the log anomaly detection techniques, it does multi-classification of issues to help us understand what's wrong with the system/app. See the implementation at [*LogAnalyzer*][link0]. 

It is based on log [template][link1] as [*Loglizer*][link2] and [*DeepLog*][link3] are.

[link0]: https://github.com/hayhan/loganalyzer
[link1]: https://github.com/logpai/logparser
